...
export default function DarkPortfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Custom ready to use website for start-ups to showcase their work.",
    ...
    },
    {
      ...
      description:
        "Property search and listing platform with advanced filtering and map integration.",
    ...
    },
    {
      ...
      description:
        "A dynamc dashboard for tracking your every interview and engagement with different firm.",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center"></div>
            ...
            <div className="hidden md:flex items-center gap-8">
              <a
                href="#projects"
                className="text-gray-400 hover:text-cyan-400 transition-colors text-sm font-medium tracking-wide"
              >
                Projects
              </a>
              <a
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 relative z-10">
              ...
              <p className="text-lg text-gray-400 leading-relaxed max-w-xl">
                ...
                Specializing in end-to-end development, from concept to
      ...
      <section id="projects" className="relative py-20 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Production-ready applications demonstrating full-stack
              capabilities
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-950 rounded-2xl p-8 lg:p-12 border border-gray-900">
            <p className="text-lg text-gray-300 leading-relaxed mb-6">
              I'm a Full-Stack Web Developer focused on building efficient,
              scalable applications that solve real business problems. My
              approach combines technical precision with practical problem
              solving to deliver solutions that work.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed mb-6">
              With expertise spanning both frontend and backend development, I
              handle the complete development lifecycle. I work with modern
              frameworks and follow industry best practices to ensure
              maintainable, high quality code.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Beyond coding, I contribute to open source projects and stay
              current with emerging technologies. I believe in writing clean,
              well-documented code and building systems designed for longevity
              and scale.
            </p>
          </div>
        </div>
